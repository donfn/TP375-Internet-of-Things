...
static BLEUUID    txcharUUID("beb5483e-36e1-4688-b7f5-ea07361b26a8");
...
static void notifyCallback(
  ...
  bool isNotify) {
    ...
    Serial.println(*pData);
          if (*pData != 0) digitalWrite(ledPin, HIGH);
...
bool connectToServer() {
    ...
    pRemoteCharacteristic2 = pRemoteService->getCharacteristic(rxcharUUID);
...
//    String newValue = "Time since boot: " + String(millis()/1000);
    String newValue = String(digitalRead(buttonPin));
